 ...
 *
 * TODO : Before implementation, please check for latest dependency or new changes given by google team.
 ...
 *         }
 *         till 1-5-2017 latest version is 3.0.0.
 *
 ...
 *     }
 *     till 1-5-2017 latest version is 10.2.6.
 *
 ...
 *
 *    7.5) select "Web Application" and follow step 7.7
 *                OR
 *    7.5) select "Android"  (As per requirement)
 *
 *    7.6) add SHA-1 key and project package name in Signing-certificate fingerprint
 *         e.g. SHA-1 key -  59:BB:34:64:E9:0D:6D:36:2A:85:0E:9D:19:7E:F7:CF:54:28:6B:B3
...
public class GoogleIntegration {
     ...
     *            use saveGooglePlusLoginData method to get the response
     *
     * *************************************************************************************************
     **/
    ...
    /**
     * To get GoogleApiClient instance
     *
     * @return mGoogleApiClient : it return GoogleApiClient instance
     */
...
//                .requestIdToken(BaseApplication.getInstance().getString(R.string.google_default_web_client_id))
                .requestProfile()
                .build();

        // Build a GoogleApiClient with access to the Google Sign-In API and the
        // options specified by gso.
        mGoogleApiClient = new GoogleApiClient.Builder(BaseApplication.getInstance())
     ...
     */
    public void onStartGoogle(final IGoogleResultInfo googleResultInfo) {
        ...
        if (opr.isDone()) {
            ...
            saveGooglePlusLoginData(result, googleResultInfo);
        } else {
            ...
            opr.setResultCallback(new ResultCallback<GoogleSignInResult>() {
                ...
                public void onResult(@NonNull GoogleSignInResult googleSignInResult) {
                 //  CustomDialog.getInstance().hide();
                    saveGooglePlusLoginData(googleSignInResult, googleResultInfo);
                }
            });
        }
    }
     ...
     */
    public void saveGooglePlusLoginData(GoogleSignInResult result, IGoogleResultInfo googleResultInfo) {
        if (result.getSignInAccount() != null) {
            ...
            Uri gPlusProfileImageUrl = result.getSignInAccount().getPhotoUrl();
            googleResultInfo.getGoogleResult(result);
        } else {
